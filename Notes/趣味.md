...
$$
\begin{aligned}
\sum_{0 \le k \le m} \binom{n}{k} &= \binom{n}{-1} + \sum_{0 \le k \le m} \binom{n}{k} \\
&= \left( \binom{n}{-1} + \binom{n}{0} \right) + \sum_{1 \le k \le m} \binom{n}{k} \\
&= \binom{n + 1}{0} + \sum_{1 \le k \le m} \binom{n}{k} \\
& \dots \\
&= \binom{n + m + 1}{m}
\end{aligned}
$$
